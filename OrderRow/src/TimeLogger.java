...
public class TimeLogger {
    ...
    public void writeToFile() {
        try {
            FileWriter fw = new FileWriter("C:\\Users\\jedib\\OneDrive\\Pictures\\Assignments\\CS-DATA\\OrderRow\\src\\leaderboard.txt", true); // append mode
            PrintWriter pw = new PrintWriter(fw);
    ...
    public static ArrayList<String> readAndSortFile() {
        ...
        try {
            File file = new File("C:\\Users\\jedib\\OneDrive\\Pictures\\Assignments\\CS-DATA\\OrderRow\\src\\leaderboard.txt");
